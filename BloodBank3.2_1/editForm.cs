...
using BloodBank3._2_1.Properties;
...
namespace BloodBank3._2_1
{
    public partial class editForm : UserControl
    {
        ...
        private donorData dd;

        public void getObj(donorData dd)
        {
            this.dd = dd;
        }
        ...
        private void editButton_Click(object sender, EventArgs e)
        {
            ...
            con.update(id,nameText.Text, proText.Text, dateCombo1.Text + "-" + month[monthCombo1.Text] + "-" + yearCombo1.Text, addText.Text, emText.Text, phText.Text, bgCombo.Text, dateCombo2.Text + "-" + month[monthCombo2.Text] + "-" + yearCombo2.Text);
            clearText();
            dd.getData(1);
        }
