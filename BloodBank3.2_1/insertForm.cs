...
namespace BloodBank3._2_1
{
    public partial class insertForm : UserControl
    {
        ...
        private void insButton_Click(object sender, EventArgs e)
        {
            ...
            con.insert(nameText.Text, proText.Text, dateCombo1.Text + "-" + month[monthCombo1.Text] + "-" + yearCombo1.Text, addText.Text, emText.Text, phText.Text, bgCombo.Text, dateCombo2.Text + "-" + month[monthCombo2.Text] + "-" + yearCombo2.Text);            
            clearText();            
            dd.getData(1);
        }
